	...
	<body>
		<?php
			if($_POST){
				...
				$myfile=fopen('hasil/inputv2.txt','w')or die("tidak bisa dibuka");
				$txt="";
...
<div class="form-group">
	...
	<div class="col-sm-10">
		<input type="text" class="form-control" id="'.$dtfilling[$i].'" name="'.$dtfilling[$i].'" placeholder="'.$dtheading[$i].'">
	</div>
</div>
';
				}
		...
		?>
		<div class="container">
			<h1>Bikin File Form Input Versi 2</h1>
			<hr/>
